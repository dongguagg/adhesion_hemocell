...
public:
  ...
  ///Adhesion variables set through hemocell.h, stored in lattice units
  T adhesionR0 = 0.0;
  T adhesionCutoff = 0.0;
  T adhesionSigma = 0.0;
  T adhesionEpsilon = 0.0;
  T adhesionD0 = 0.0;
  T adhesionAlpha = 0.0;
...
public:
  ...
  class HemoAdhesionForce: public HemoCellFunctional {
   void processGenericBlocks(plb::Box3D, std::vector<plb::AtomicBlock3D*>);
